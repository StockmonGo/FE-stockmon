  ...
  const handleCatch = async () => {
    ...
    try {
      ...
      if (res) {
        ...
        router.push(
          `/game/new-stockmon?id=${stockmonGame.stockmonId}&pr=${res.stockPrice}&tpr=${res.stockTotalPrice}&name=${res.stockmonName}&desc=${res.description}&market=${res.stockMarket}&st=${res.stockType}&stn=${res.stockTypeName}&std=${res.stockCode}&first=${res.isFirst}`
        );
      }
    } finally {
      setIsLoading(false);
